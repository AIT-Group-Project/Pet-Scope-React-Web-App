  ...
  return (
    <form>
      ...
      <label type='text'>
        ...
        <input ref={registerFirstNameElement} type='text' className='w-full p-1 my-1 text-black' required/>
      </label>

      <label type='text'>
        <p className='text-black dark:text-white'>Last Name</p>
        <input ref={registerLastNameElement} type='text' className='w-full p-1 my-1 text-black' required/>
      </label>

      <label type='text'>
        <p className='text-black dark:text-white'>Email</p>
        <input ref={registerEmailElement} type='email' className='w-full p-1 my-1 text-black' required/>
      </label>

      <label type='text'>
        <p className='text-black dark:text-white'>Password</p>
        <input ref={registerPasswordElement} type='password' className='w-full p-1 my-1 text-black' required/>
      </label>

      <div className = 'text-black relative text-xl text-center rounded-lg p-3 my-2 dark:bg-slate-500 dark:hover:bg-slate-500/[0.5]'>
